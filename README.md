...
-   Finally, building this report serves as a proof of concept, illustrating all of the cool things you can do when automating the stages of statistical analysis. We hope that this report can provide some inspiration for others, encouraging the development of other useful---and hopefully even educational---tools!
